    ...
    <div className={styles.page}>
      <div className={styles.left}>
        ...
        <div className={styles.leftContent}>
          ...
          <p className={styles.leftSub}>Sign in to continue managing your compliance, audit, legal, and HR operations in one unified workspace.</p>
          <div className={styles.leftPoints}>
            {['Real-time compliance score','Open audit & legal notices','Pending deadlines & tasks','AI-powered recommendations','Team workflow updates'].map(p => (
      ...
      <div className={styles.right}>
        <div className={styles.formCard}>
          <div className={styles.formHeader}>
            ...
            <p className={styles.formSub}>No account yet? <Link to="/signup" className={styles.formLink}>Create one free</Link></p>
          </div>
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <div className={styles.forgotRow}><a href="#" className={styles.forgot}>Forgot password?</a></div>
